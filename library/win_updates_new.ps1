...
$job_body = {
    ...
    Try { 
        ...
        return @{ job_output = DoWindowsUpdate @boundparms @unboundargs }
    }
    Catch {
        $excep = $_
...
$common_inject = {
    ...
    Function Write-DebugLog {
        ...
        $msg = "$date_str $msg"
        Write-Debug $msg
        if($global:log_path -ne $null) {
            Add-Content $global:log_path $msg
        }
    }
}
# inject the common code into the current scope
. $common_inject
